              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-shrink-0 items-center gap-2 pr-4">
                  ...
                  >
                    ...
                    <span className="hidden sm:block truncate max-w-[120px]">{activeModel.label}</span>
                    <svg className="hidden sm:block w-3 h-3 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
